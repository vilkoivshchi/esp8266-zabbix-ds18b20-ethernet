        ...
        if (c == '\n' && lineIsBlank) {
          ...
          if (strcmp(webPageAddr, "/") == 0) {
            ...
            if (strcmp(base64Str, webAuthTokenStr) == 0) {
              ...
              client.print(F("<td colspan = \"2\" ><input name=\"ip_a\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\" pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[1-9][0-9]?)$\" placeholder=\""));
              client.print(ip[0]);
              client.print(F("\" required></td>"));
              client.println(F("<td colspan = \"2\"><input name=\"ip_b\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              client.print(ip[1]);
              client.print(F("\" required></td>"));
              client.println(F("<td colspan = \"2\"><input name=\"ip_c\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              client.print(ip[2]);
              client.print(F("\" required></td>"));
              client.println(F("<td colspan = \"2\"><input name=\"ip_d\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              client.print(ip[3]);
              client.print(F("\" required></td></tr>"));
              client.println(F("<tr><td colspan = \"1\">subnet</td>"));
              client.println(F("<td colspan = \"2\"><input name=\"mask_a\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              client.print(mask[0]);
              client.print(F("\" required></td>"));
              client.println(F("<td colspan = \"2\"><input name=\"mask_b\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              client.print(mask[1]);
              client.print(F("\" required></td>"));
              client.println(F("<td colspan = \"2\"><input name=\"mask_c\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              client.print(mask[2]);
              client.print(F("\" required></td>"));
              client.println(F("<td colspan = \"2\"><input name=\"mask_d\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              client.print(mask[3]);
              client.print(F("\" required></td></tr>"));
              client.println(F("<tr><td colspan = \"1\">gateway</td>"));
              client.println(F("<td colspan = \"2\"><input name=\"gate_a\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[1-9][0-9]?)$\" placeholder=\""));
              client.print(gateway[0]);
              client.print(F("\" required></td>"));
              client.println(F("<td colspan = \"2\"><input name=\"gate_b\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              client.print(gateway[1]);
              client.print(F("\" required></td>"));
              client.println(F("<td colspan = \"2\"><input name=\"gate_c\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              client.print(gateway[2]);
              client.print(F("\" required></td>"));
              client.println(F("<td colspan = \"2\"><input name=\"gate_d\" type=\"text\" form=\"change_ip\" maxlength=\"3\" size=\"2\"  pattern=\"^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$\" placeholder=\""));
              ...
              client.print(F("<tbody><tr><td colspan = \"100%\"><a href=\"http://"));
              client.print(Ethernet.localIP());
              client.print(F("/\">Main page</a></td></tr>"));
              client.print(F("<tr><td colspan = \"50%\">Resolution:<input type=\"text\" name=\"ds_res\" form=\"ds_set_res\" maxlength=\"2\" size=\"2\" pattern=\"^(9|1[0-2])$\" title=\"9...12\" placeholder=\""));
              ...
              client.println(F("</td></tr>"));
              client.println(F("<tfoot><tr><td colspan = \"100%\">Dummy</td></tr></tfoot></table><p></p>"));
